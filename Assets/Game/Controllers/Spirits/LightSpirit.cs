...
public class LightSpirit : Spirit {
    ...
    [SerializeField, ReadOnly] public bool continueDash;
    ...
    void LateUpdate() {
        continueDash = Input.GetKey(actionKey);
    }
    ...
    private void Dash() {
        ...
        Vector2 dashVector = directionFlag == Controller.Direction.Right ? Vector2.right : Vector2.left; // new Vector2(Input.GetAxisRaw("Horizontal"), 0f).normalized;
