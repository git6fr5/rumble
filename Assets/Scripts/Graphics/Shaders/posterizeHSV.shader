    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // hsv.x = floor(hsv.x * _ValuePosterity) / _ValuePosterity;
                hsv.y = floor(hsv.y * _ValuePosterity) / _ValuePosterity;
                // hsv.z = floor(hsv.z * _ValuePosterity) / _ValuePosterity;
                if (hsv.z < 0) {
                    hsv.z = 0;
                }
                // if (hsv.z < 0.001) {
