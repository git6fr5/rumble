...
//         // _PaperTex ("_PaperTex", 2D) = "white" {}
//         // _NoiseTex ("_NoiseTex", 2D) = "white" {}
//         // _StippleTex ("_StippleTex", 2D) = "white" {}
//         // _InkTex ("_InkTex", 2D) = "white" {}

//         // _ContrastThreshold ("_ContrastThreshold", float) = 0;
//         // _HighThreshold ("_HighThreshold", float) = 0;
//         // _LowThreshold ("_LowThreshold", float) = 0;
//         // _LuminanceCorrection ("_LuminanceCorrection", float) = 0;
//         // _Contrast ("_Contrast", float) = 0;
//         // _StippleSize ("_StippleSize", float) = 0;
//         // _UsingImage ("_UsingImage", int) = 0;
//     }
