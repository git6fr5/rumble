...
namespace Platformer.Objects.Decorations {
    ...
    public class Stem : MonoBehaviour {
        ...
        private void DrawFullyGrownPoints(int index) {
            ...
            // if (index > currPoints) {
            //     for (int i = currPoints; i < index; i++) {
            ...
            //     }
            // }
            // else if (index < currPoints) {
            //     for (int i = currPoints - 1; i >= index; i--) {
            //         spline.RemovePointAt(i);
            //     }
            //     // m_Head.localPosition = m_CachedPositions[index - 1];
            // }
        ...
        private void DrawLeftover(float leftover) {
            ...
            // print(m_CachedLeftTangents[currPoints]);
            // print(m_CachedPositions[currPoints]);
            // return;
