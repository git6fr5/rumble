...
namespace Platformer.Objects {
    ...
    public class SpriteShapeCollider : MonoBehaviour {
        ...
        Vector3 FourPointBezierCurve(int i, int j) {
        ...
        void CreateCollider() {
            ...
            m_Obstacle.AddCollider(collider);
            m_Obstacle.AddCollider(boxA);
            m_Obstacle.AddCollider(boxB);

        }

        BoxCollider2D AddCap(int index0, int index1) {
            ...
            box.GetComponent<SpriteShapeCap>().obstacle = m_Obstacle;
