    ...
    public class PlatformEntity : Entity {
        ...
        public static int GetLength(Vector3 position) {
            ...
            while (continueSearch && length < 50) {
                ...
                RaycastHit2D hit = Game.Physics.Collisions.Look(); // Can I do this purely though LDtk?
                // Vector3 offset = ((length - 1f) + 0.5f + PhysicsSettings.CollisionPrecision) * Vector3.right;
